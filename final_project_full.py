# -*- coding: utf-8 -*-
"""
Created on Wed May 15 02:11:37 2019
...
## RANDOM ROUTE FROM ANKARA TO EVERY CITY AND RETURN TO ANKARA------------------

randroute = get_route(n)
length_route = get_route_length(randroute)
randroute_path = draw_route(randroute)
print(randroute)
print(length_route)

## SHORTEST ROUTE FROM ANKARA TO EVERY CITY AND RETURN TO ANKARA-----------------
